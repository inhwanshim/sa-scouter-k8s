...
#JAVA_OPTS=" $JAVA_OPTS -javaagent:/usr/local/tomcat/scouter/agent.java/scouter.agent.jar"
#JAVA_OPTS=" $JAVA_OPTS -Dscouter.config=/usr/local/tomcat/scouter/agent.java/conf/scouter.conf"
#JAVA_OPTS=" $JAVA_OPTS -Dobj_name=tomcat"
#----- Scouter Java configuration 2022/10/10 ------------------------------------------------------------------------
